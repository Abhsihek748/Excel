...
function scrollXR() {
    ...
    scrollXRInterval = setInterval(() => {
        $("#cells").scrollRight($("#cells").scrollRight() + 100);
    }, 100);
}
        ...
        $(".sheet-rename").click(function (e) {
            let renameModal = $(`<div class="sheet-modal-parent">
                                    <div class="sheet-rename-modal">
                                        ...
                                        <div class="sheet-modal-input-box">
            ...
            if (totalSheets > 1) {
                let deleteModal = $(`<div class="sheet-modal-parent">
                                    <div class="sheet-delete-modal">
                                        ...
                                        <div class="sheet-modal-detail-box">
                                            <span class="sheet-modal-detail-title">Are you sure?</span>
                                        </div>
                                        <div class="sheet-modal-confirmation">
                                            <div class="button yes-modal">
...
$("#menu-file").click(function(e){
    let fileModal = $(`<div class="home">
    <div class="file-option-modal">
        <div class=" file-options close">
            <div class="file-icon material-icons close-icon ">arrow_circle_down</div>
            <div>Close</div>
        </div>
        <div class=" file-options new">
            <div class="file-icon material-icons new-icon">insert_drive_file</div>
            <div>New</div>
        </div>
        <div class=" file-options open">
            <div class="file-icon material-icons open-time ">folder_open</div>
            <div>Open</div>
        </div>
        <div class=" file-options save">
            <div class="file-icon material-icons save-time">save</div>
            <div>Save</div>
        </div>
    </div>
...
$(".new").click(function(e){
    ...
    { newFile();
     ...
     <div class="sheet-modal-detail-box">
         <span class="sheeet-modal-detail-title">Do you want to save</span>
     </div>
     <div class="sheet-modal-confirmation">
         <div class="button yes-modal">Yes</div>
         <div class="button no-modal">No</div>
      </div>
      </div>
      </div>`)
...
function saveFile(newF) {
    $(".container").append(`
    <div class="sheet-modal-parent">
     <div class="sheet-rename-modal">
    <div class="sheet-modal-title">Save File </div>
    <div class="sheet-modal-input-box">
        <span class="sheeet-modal-input-title">File Name :</span>
        <input class="sheet-modal-input" value =${$(".title").text()} >
    </div>
    <div class="sheet-modal-confirmation">
        <div class="button yes-modal">Ok</div>
        <div class="button no-modal">Cancel</div>
    ...
    $(".no-modal,.yes-modal").click(function (e) {
        $(".sheet-modal-parent").remove();
        if(newF)
        newFile();
    });
...
function openFile(){
    ...
    inputFile.change(function(e){
        ...
        let sheet = Object.keys(cellData);
        lastlyAddedSheet = 1;
        for(let i of sheet){
            if(i.includes("Sheet")){
             let splittedSheet = i.split("Sheet");
             if(splittedSheet.length == 2 && !isNaN(splittedSheet[1]))
             lastlyAddedSheet = parseInt(splittedSheet[1]);
            }
